...
class TestingExasolH2JdbcClient
        extends BaseJdbcClient
{
    private static final Logger log = Logger.get(TestingExasolH2JdbcClient.class);
    ...
    public TestingExasolH2JdbcClient(BaseJdbcConfig config, ConnectionFactory connectionFactory)
    {
        this(config, connectionFactory, new DefaultQueryBuilder(RemoteQueryModifier.NONE), new DefaultIdentifierMapping());
    }

    public TestingExasolH2JdbcClient(BaseJdbcConfig config, ConnectionFactory connectionFactory, QueryBuilder queryBuilder, IdentifierMapping identifierMapping)
    {
