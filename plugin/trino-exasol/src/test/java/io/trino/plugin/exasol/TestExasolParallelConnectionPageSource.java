...
public class TestExasolParallelConnectionPageSource
{
            ...
            throws Exception
    {
        ...
        session = TestingConnectorSession.builder()
                .setPropertyMetadata(new ExasolSessionProperties(new ExasolConfig()).getSessionProperties())
                .setPropertyValues(ImmutableMap.of("parallel_connections_worker_count", 4))
                .build();
    ...
    {
        try (ConnectorPageSource pageSource = createPageSource(ImmutableList.of(
    ...
    public void testIdempotentClose()
            throws IOException
    {
        ConnectorPageSource pageSource = createPageSource(ImmutableList.of(
                columnHandles.get("value"),
                columnHandles.get("value"),
                columnHandles.get("text")));
    ...
    private ConnectorPageSource createPageSource(List<JdbcColumnHandle> columnHandles)
    {
        return ExasolParallelConnectionPageSource.create(jdbcClient, executor, parallelConnectionFactory, session, split, table, columnHandles);
    }
}
